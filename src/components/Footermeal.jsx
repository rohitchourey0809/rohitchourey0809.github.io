        ...
        <div className="mx-auto w-full max-w-screen-xl">
          <div className="grid grid-cols-3 gap-8 px-4 py-6 lg:py-8 md:grid-cols-6">
            <div>
              ...
              <ul className="flex flex-col gap-2 underline">
                <li className="footerItem">
                  <a className="cta" href="/why-mailchimp/">
                    Why Mailchimp?
                  </a>
                </li>
                <li className="footerItem">
                  <a className="cta" href="/whats-new/">
                    Product Updates
                  </a>
                </li>
                <li className="footerItem">
                  <a className="cta" href="/features/email/">
                    Email Marketing
                  </a>
                </li>
                <li className="footerItem">
                  <a className="cta" href="/features/website-builder/">
                    Websites
                  </a>
                </li>
                <li className="footerItem">
                ...
                <li className="footerItem">
                  <a className="cta" href="/resources/mailchimp-comparisons/">
                    How We Compare
                  </a>
                </li>
                <li className="footerItem">
                  <a className="cta" href="/gdpr/">
                    GDPR Compliance
                  </a>
                </li>
                <li className="footerItem">
                  <a className="cta" href="/about/security/">
                    Security
                  </a>
                </li>
                <li className="footerItem">
                  <a className="cta" href="https://status.mailchimp.com/">
                    Status
                  </a>
                </li>
                <li className="footerItem">
                  <a className="cta" href="/features/mailchimp-mobile/">
                    Mobile App
                  </a>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="flex flex-col gap-2 underline">
                ...
                <li className="footerItem">
                  <a
                    className="cta"
                    href="/resources/free-marketing-features-overview/"
                ...
                <li className="footerItem">
                  <a className="cta" href="/marketing-glossary/">
                    Marketing Glossary
                  </a>
                </li>
                <li className="footerItem">
                  <a className="cta" href="/integrations/">
            ...
            <div>
              ...
              <ul className="flex flex-col gap-2 underline">
                <li className="footerItem">
                  <a className="cta" href="/andco/">
                    Agencies &amp; Freelancers
                  </a>
                </li>
                <li className="footerItem">
                  <a className="cta" href="https://mailchimp.com/developer/">
                    Developers
                  </a>
                </li>
                <li className="footerItem">
                  <a className="cta" href="/events/" aria-label="Events">
                    Events
                  </a>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="flex flex-col gap-2 underline">
                ...
                <li className="footerItem">
                  <a
                    className="cta"
                    href="https://mailchimp.com/givewhereyoulive"
                    target="_blank"
            ...
            <div>
              ...
              <ul className="flex flex-col gap-2 underline">
                ...
                <li className="footerItem">
                  <a className="cta" href="/experts/">
                    Hire an Expert
                  </a>
                </li>
                <li className="footerItem">
                  <a className="cta" href="/help/" aria-label="Help Center">
                    Help Center
                  </a>
                </li>
                <li className="footerItem">
                  <a
                    className="cta"
                    href="https://mailchimp.com/sales/"
    ...
    "label":"image_link: mailchimp"
          ...
          https://eep.io/images/yzco4xsimv0y/64EpnI4RsQI66c2y2O60G2/4c34d7bc4dd7a4362c7e19a06c109e21/icon-android.svg?w=320&amp;q=70 320w"
            ...
            <div>
              ...
              <ul className="cell socialMedia flex flex-row gap-4">
                <li className="globalFooter__item--social">
                  <a
                    href="https://www.facebook.com/mailchimp/"
                    aria-label="Facebook"
            ...
            "
                ...
                <li className="globalFooter__item--social">
                  <a
                    href="https://twitter.com/Mailchimp"
                    aria-label="Twitter"
            ...
            "
                ...
                <li className="globalFooter__item--social">
                  <a
                    href="https://www.instagram.com/mailchimp/"
            ...
            "
                ...
                <li className="globalFooter__item--social">
                  <a
                    href="https://www.linkedin.com/company/mailchimp"
                    aria-label="LinkedIn"
            ...
            "
                ...
                <li className="globalFooter__item--social">
                  <a
                    href="https://www.youtube.com/user/Mailchimp"
                    aria-label="YouTube"
            ...
            "
                ...
                <li className="globalFooter__item--social">
                  <a
                    href="https://www.pinterest.com/mailchimp/"
